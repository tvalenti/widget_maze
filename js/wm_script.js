...
function updatePreview() {
   ...
   formStyles.indentVal.value=formStyles.textindent.value+"px";
   formStyles.lineHghtVal.value=formStyles.lineheight.value+"em";
   formStyles.fontSizeVal.value=formStyles.fontsize.value + "px";
   formStyles.letterSpacingVal.value=formStyles.letterspacing.value+"px";
   formStyles.wordSpacingVal.value=formStyles.wordspacing.value+"px";
